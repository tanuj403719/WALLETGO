...
@router.post("/analyze")
async def analyze_scenario(request: ScenarioRequest, user_id: str = Depends(verify_token)):
...
async def get_scenario_suggestions(language: str = "en", user_id: str = Depends(verify_token)):
