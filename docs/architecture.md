...
| AI Service | `src/ai-service/` | FastAPI, Gemini SDK | NLP explanations, intent extraction |
...
2. **Graceful AI fallback** — Template responses when `GEMINI_API_KEY` is absent.
